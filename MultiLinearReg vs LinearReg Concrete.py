...
plt.savefig("output/concrete_feature_scatter.png", dpi=200, bbox_inches='tight')
plt.show()
...
fig.tight_layout(pad=3.0)
plt.savefig("output/concrete_histograms.png", dpi=200, bbox_inches='tight')
plt.show()

cor_matrix = data.corr()
sns.heatmap(cor_matrix,annot=True,cmap="coolwarm")
plt.savefig("output/concrete_corr_heatmap.png", dpi=200, bbox_inches='tight')
plt.show()
...
plt.savefig("output/concrete_pca_1d.png", dpi=200, bbox_inches='tight')
plt.show()
...
fig.tight_layout(pad=3.0)
plt.savefig("output/concrete_single_feature_fits.png", dpi=200, bbox_inches='tight')
plt.show()    
...
fig.tight_layout(pad=3.0)
plt.savefig("output/concrete_residuals_before.png", dpi=200, bbox_inches='tight')
plt.show()
...
ax3.set_ylabel('Frequency')
fig.tight_layout(pad=3.0)
plt.savefig("output/concrete_residuals.png", dpi=200, bbox_inches='tight')
plt.show()